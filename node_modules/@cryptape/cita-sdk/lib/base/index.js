...
exports.default = (web3) => {
    ...
    web3.base.deploy = (contract, transaction) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const _tx = Object.assign(Object.assign({ version: 0, value: 0, nonce: Math.round(Math.random() * 10) }, transaction), { data: bytecode.replace(/^0x/, '') + encodedArgs, validUntilBlock: +currentHeight + 88 });
    ...
    web3.base.storeAbi = (contractAddress, abi, options) => __awaiter(void 0, void 0, void 0, function* () {
        if (!contractAddress) {
        ...
        const _tx = Object.assign(Object.assign({ version: 0, value: 0, nonce: Math.round(Math.random() * 10) }, options), { to: web3.base.abiAddress });

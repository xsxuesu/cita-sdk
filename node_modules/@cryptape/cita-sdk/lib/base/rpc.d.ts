...
export declare const signTransaction: {
    ...
    call: string;
    params: number;
    inputFormatter: (({ from, privateKey, data, nonce, quota, validUntilBlock, value, version, chainId, to, cryptoTx }: {
        from: string;
        privateKey: string;
        ...
        to?: string | undefined;
        cryptoTx: import("@cryptape/cita-signer/lib/enum").CryptoTx;

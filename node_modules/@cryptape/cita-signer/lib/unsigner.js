...
const unsigner = (hexUnverifiedTransaction, cryptoTx = enum_1.CryptoTx.SECP256K1) => {
    ...
    if (cryptoTx === enum_1.CryptoTx.SECP256K1) {
        ...
        const address = `0x${index_1.bytes2hex(index_1.sm3().sum(index_1.hex2bytes(publicKey.slice(2))))
            .slice(-40)
            .toLowerCase()}`;
        result = {
            transaction,

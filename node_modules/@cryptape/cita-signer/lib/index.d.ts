...
export declare const sm2: any;
export declare const sm3: any;
...
declare const signer: ({ from, privateKey, data, nonce, quota, validUntilBlock, value, version, chainId, to, cryptoTx }: {
    from: string;
    privateKey: string;
